...
const item: LibraryItem = { title: "Elon Musk: Tesla, SpaceX, and the Quest for a Fantastic Future", author: "Ashlee Vance", copies: 3 };

// Unions
let union : string | number = 'Elon Musk'
