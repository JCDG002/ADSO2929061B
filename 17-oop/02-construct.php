...
$pl = new PlayList('Elon Musk Favorites');
$pl->setPlayList('SpaceX Launch', 'Electronic', 'https://via.placeholder.com/160', 2024);
$pl->setPlayList('Tesla Autopilot', 'Ambient', 'https://via.placeholder.com/160', 2023);
$pl->setPlayList('Neuralink Demo', 'Tech', 'https://via.placeholder.com/160', 2024);
